        ...
        this.headerBanners = [
            {
                ...
                link: `${this.basePath}pages/iran-off.html`
            },
            {
                id: 2,
                image: `${this.basePath}assets/images/head-banner/H2.png`,
                link: `${this.basePath}pages/bpb-guide.html`
            },
            {
                id: 3,
                    ...
                    <div class="hamburger-overlay">
                        <div class="hamburger-menu">
                            ...
                            <div class="hamburger-main-grid">
                                <a href="${this.basePath}index.html" class="hamburger-card">
                                ...
                                <a href="${this.basePath}pages/articles.html" class="hamburger-card">
                                    <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                ...
                                <a href="${this.basePath}pages/about.html" class="hamburger-card">
                                    <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            ...
                            <!-- Tools Section -->
                            <h3 class="hamburger-section-title">ابزارهای ما</h3>
                            <div class="hamburger-tools">
                                ...
                                <a href="${this.basePath}pages/iran-off.html" class="tool-card tool-dark">
                                    <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
                                        <circle cx="12" cy="12" r="10"></circle>
                                ...
                                <a href="${this.basePath}pages/bpb-guide.html" class="tool-card tool-green">
